...
import java.util.Properties;
        ...
        public class Email {
            public static void main(String[] args) {
                ...
                String from = "mojesmaczne@wp.pl";
                final String username = "mojesmaczne@wp.pl";//username generated by Mailtrap
                final String password = "Mojeh@slo!2";//password generated by Mailtrap
